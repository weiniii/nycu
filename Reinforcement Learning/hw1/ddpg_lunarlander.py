...
class DDPG(object):
    def __init__(self, num_inputs, action_space, gamma=0.995, tau=0.0005, hidden_size=128, lr_a=1e-3, lr_c=1e-3):
...
def train():    
    ...
    for i_episode in range(num_episodes):
        ...
        while True:
            ...
            memory.push(state, action, torch.Tensor([1- done]), next_state, torch.Tensor([reward]))
